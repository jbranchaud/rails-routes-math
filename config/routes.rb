Rails.application.routes.draw do
  ...
  get '/:op1/plus/:op2' => 'application#add',
    constraints: { :op1 => number, :op2 => number },
    to: proc { |env| [200, {}, ["#{:op1.to_i + :op2.to_i}"]] }
  get '/:op1/plus/:op2' => 'application#bad_request'

  get '/:op1/minus/:op2' => 'application#subtract',
    constraints: { :op1 => number, :op2 => number },
    to: proc { |env| [200, {}, ["#{:op1.to_i - :op2.to_i}"]] }
  get '/:op1/minus/:op2' => 'application#bad_request'

  get '/:op1/times/:op2' => 'application#multiply',
    constraints: { :op1 => number, :op2 => number },
    to: proc { |env| [200, {}, ["#{:op1.to_i * :op2.to_i}"]] }
  get '/:op1/times/:op2' => 'application#bad_request'

  get '/:op1/by/:op2' => 'application#divide',
